...
class Encoder(nn.Module):
    ...
    def __init__(self, input_shape, latent_dim):
        ...
        self.fc = nn.Linear(256*4*4, self.latent_dim)   #256*8*8 if 64*64 input
        ##################################################################
        #                          END OF YOUR CODE                      #
        ##################################################################
...
class Decoder(nn.Module):
    ...
    def __init__(self, latent_dim, output_shape):
        ...
        ##################################################################
        self.base_size = (256, 4, 4) # 256, 8, 8 if 64*64
        ...
        self.fc = nn.Linear(self.latent_dim, np.prod(self.base_size))
        ##################################################################
        #                          END OF YOUR CODE                      #
        ##################################################################
    ...
    def forward(self, z):
        ...
        ##################################################################
        z = self.fc(z)
        z = z.view(z.size(0), *self.base_size)
        z = self.deconvs(z)
        return z
        ##################################################################
        #                          END OF YOUR CODE                      #
